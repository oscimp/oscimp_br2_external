...
ZIO_MODULE_MAKE_OPTS = GIT_VERSION=1.4.2-0-g14f5bc8
...
ZIO_MODULE_MAKE_OPTS += CONFIG_ZIO_DEVICES=m
ZIO_MODULE_MAKE_OPTS += CONFIG_ZIO_BUFFERS=m
ZIO_MODULE_MAKE_OPTS += CONFIG_ZIO_TRIGGERS=m
